...
public class ApptFullErrorDialog extends JDialog {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7491508428843665285L;
	...
	public static void main(String[] args) {
		try {
			ApptFullErrorDialog dialog = new ApptFullErrorDialog(null, true);
	 ...
	 * Create the dialog.
	 */
	public ApptFullErrorDialog(MyCalendar parent,boolean modal) {
		super(parent, "Error", modal);
		owner=parent;
		setBounds(300, 300, 400, 149);
		contentPanel.setBorder(new EmptyBorder(5, 5, 5, 5));
		{
			lblErrorPleaseCheck = new JLabel("Specified time is fully booked.");
		}
		{
		...
		JLabel lblAppointmentsMustBe = new JLabel("Please choose another time.");
	...
	private class SwingAction extends AbstractAction {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -5104066469033550933L;
		public SwingAction() {
			putValue(NAME, "OK");
